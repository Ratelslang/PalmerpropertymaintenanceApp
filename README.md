...
|---|---|
| Work orders | Property, unit/area, reporter, safety controls, access notes, priority, due date, appointment window, next owner, workflow status, and full history. |
...
| Management visibility | Dashboard action queue, overdue/urgent/approval alerts, finance register, budget variance, contractor register, CSV exports, owner pack, and printable job cards. |
