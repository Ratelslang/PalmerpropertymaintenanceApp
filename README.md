...
|---|---|
| Work orders | Property, unit/area, reporter, safety controls, access notes, priority, due date, appointment window, next owner, workflow status, full history, and explicit **Edit** / **Delete** controls in the register and job view. |
